...
foreach($arResult['arrProp'] as $prop_id => $arProp)
{
	...
	switch($arProp['PROPERTY_TYPE'])
	{
		...
		case 'N':
            ...
            $min_value = !empty($value_left) ? $value_left : $arResult['arNumMaxMin'][$arProp['CODE']]['MIN'];
            $max_value = !empty($value_right) ? $value_right : $arResult['arNumMaxMin'][$arProp['CODE']]['MAX'];


            $res .= '<span class="ts-ot-do">';
			$res .= '<input type="text" id="'. $arProp['CODE'] .'_LEFT"  name="' . $name . '" style="' . $arParams['NUMBER_WIDTH'] . '" value="' . htmlspecialcharsbx($value_left) . '" '. ($arParams['INCLUDE_PLACEHOLDER'] ? ' placeholder="'. $min_value .'"':  '') . '  />&nbsp;' . GetMessage('CC_BCF_TILL') . '&nbsp;';
			...
			$res .= '<input type="text" id="'. $arProp['CODE'] .'_RIGHT" name="' . $name . '" style="' . $arParams['NUMBER_WIDTH'] . '" value="' . htmlspecialcharsbx($value_right) . '"  '. ($arParams['INCLUDE_PLACEHOLDER'] ? ' placeholder="'. $max_value .'"':  '') . ' />';
